...
exports.bulkUploadPurchaseOrder = void 0;
...
const bulkUploadPurchaseOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        for (const row of data) {
            ...
            const rawDate = (_c = row['Date']) === null || _c === void 0 ? void 0 : _c.toString();
            const amount = parseFloat(row['Amount (Kgs)'].toString());
            const notes = ((_d = row['Notes']) === null || _d === void 0 ? void 0 : _d.toString()) || '';
            // Debug first row
...
exports.default = exports.bulkUploadPurchaseOrder;
