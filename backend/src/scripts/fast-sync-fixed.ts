...
async function fastSyncFixed() {
  console.log('🚀 Fast sync with correct column mapping...\n');
  ...
  try {
    ...
    // 2. Sync Purchases - WITH CORRECT COLUMN MAPPING
...
if (require.main === module) {
  fastSyncFixed().catch(console.error);
}

export { fastSyncFixed };